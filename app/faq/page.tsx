...
const faqs = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Anda membutuhkan jasa forwarder ketika ingin ekspor/impor tapi tidak punya pengalaman, belum memiliki izin dan dokumen lengkap, tidak punya waktu untuk mengurus sendiri, atau ingin proses yang lebih cepat dan efisien.",
      },
      {
    ...
    items: [
      {
        ...
        a: "Kami menawarkan: Layanan Ekspor, Layanan Impor, Perizinan dan Dokumentasi, Customs Clearance, dan Consulting ekspor-impor.",
      },
      {
        q: "Berapa lama proses ekspor-impor?",
        a: "Rata-rata: Konsultasi 1–2 hari → Persiapan Dokumen 3–7 hari → Pengiriman & Clearance 5–14 hari. Total sekitar 2–3 minggu, tergantung jenis barang dan rute.",
      },
      {
        q: "Berapa biaya jasa forwarder?",
        a: "Biaya bervariasi tergantung jenis barang, rute/negara tujuan, berat/volume barang, kompleksitas dokumen, dan metode pengiriman. Kami memberikan penawaran detail setelah konsultasi awal.",
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: "Dokumen apa yang harus saya siapkan?",
        a: "Dokumen bergantung pada jenis barang. Secara umum: Invoice, Packing List, NPWP, dan KTP/Akta Pendirian Perusahaan. Untuk barang tertentu ada persyaratan tambahan. Hubungi kami untuk daftar lengkap.",
      },
      {
      ...
      },
      {
        ...
        a: "Durasi tergantung jenis izin. Rata-rata 2–7 hari kerja. Beberapa izin khusus bisa lebih lama. Kami akan memberikan estimasi akurat saat konsultasi.",
      },
      {
        q: "Apakah izin bersifat permanen?",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Jika ada delay, kami segera mengidentifikasi penyebab dan melakukan tindakan korektif. Kami selalu komunikasi dengan Anda dan update perkembangan terbaru.",
      },
      {
        q: "Apakah barang diasuransikan?",
        a: "Kami dapat mengatur asuransi pengiriman. Jenis dan besarnya tergantung nilai barang dan preferensi Anda. Kami jelaskan opsi asuransi saat konsultasi.",
      },
      {
        q: "Bagaimana jika barang rusak atau hilang?",
        a: "Jika ada kerusakan/kehilangan, kami segera laporkan ke pihak pengangkut dan asuransi (jika ada). Kami bantu proses claim untuk penggantian/kompensasi.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "Sistem pembayaran biasanya: DP 50% saat kontrak, 30% saat dokumen siap, dan sisanya 20% saat barang tiba. Kami fleksibel sesuai kesepakatan.",
      },
      {
        q: "Apa metode pembayaran yang diterima?",
        a: "Kami menerima transfer bank, cheque, e-wallet, dan cash. Untuk kemudahan, kami lebih prefer transfer bank.",
      },
      {
    ...
    items: [
      {
        ...
        a: "Jam kerja kami: Senin–Jumat 08:00–17:00, Sabtu 08:00–13:00 (WIB). Untuk kasus urgent, Anda bisa menghubungi WhatsApp kami.",
      },
      {
        q: "Bagaimana cara menghubungi?",
        a: "Via WhatsApp +6281314705885, email info@forwarder.id, atau datang langsung ke kantor kami di Jakarta.",
      },
      {
      ...
      <main style={{ flex: 1 }}>
        ...
        <section style={{ padding: "50px 32px 64px", background: "#fff" }}>
          <div style={{ maxWidth: 960, margin: "0 auto" }}>
            ...
            >
              Jawaban atas pertanyaan umum dari klien kami. Tidak menemukan
              jawabannya? Hubungi kami langsung.
            </p>
          </div>
        </section>
              ...
              <div key={sIdx} style={{ marginBottom: 56 }}>
                ...
                {section.items.map((item, iIdx) => {
                  ...
                  return (
                    <div
                      key={itemId}
                      style={{ borderBottom: "1px solid #d9d9dd" }}
                    >
                      <button
        ...
        <section style={{ padding: "80px 32px", background: "#eeece7" }}>
          <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
            ...
            >
              ...
              <a href="mailto:info@forwarder.id" style={S.pillOutline}>
                Kirim Email
              </a>
            </div>
          </div>
