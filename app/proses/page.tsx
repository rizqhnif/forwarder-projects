      ...
      <main style={{ flex: 1 }}>
        ...
        <section style={{ padding: "80px 32px 64px", background: "#fff" }}>
          <div style={{ maxWidth: 960, margin: "0 auto" }}>
            ...
            <p style={{ fontSize: 18, color: "#616161", maxWidth: 520, lineHeight: 1.5, marginBottom: 40 }}>
              Proses yang jelas, transparan, dan didampingi tim profesional dari awal hingga barang tiba.
            </p>
          </div>
        </section>
                ...
                <div style={{
                  ...
                  <div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 8, marginBottom: 12 }}>
                      <h2 style={{ fontSize: 28, fontWeight: 400, letterSpacing: "-0.3px", color: "#17171c" }}>
                        {step.title}
                      </h2>
                      <span style={{
                        fontFamily: "'Courier New', monospace",
                    ...
                    <p style={{ fontSize: 16, color: "#616161", lineHeight: 1.6, marginBottom: 24, maxWidth: 560 }}>
                      {step.desc}
                    </p>
                    <div style={{
                      background: "#eeece7",
                      ...
                      <p style={{ fontSize: 12, fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.5px", color: "#93939f", marginBottom: 14 }}>
                        Yang kami lakukan
                      </p>
        ...
        <section style={{ padding: "80px 32px", background: "#eeece7" }}>
          <div style={{ maxWidth: 960, margin: "0 auto" }}>
            ...
            <div style={{
              ...
              {[
                { label: "Konsultasi", duration: "1–2 Hari", note: "Planning & kick-off" },
                { label: "Persiapan Dokumen", duration: "3–7 Hari", note: "Izin & kelengkapan" },
                { label: "Pengiriman", duration: "5–14 Hari", note: "Clearance & delivery" },
              ].map((item) => (
                <div key={item.label} style={{ background: "#fff", borderRadius: 8, padding: 28 }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 14, color: "#616161" }}>
                <strong style={{ color: "#17171c" }}>Catatan:</strong> Waktu dapat berbeda tergantung jenis barang, rute, dan kelengkapan dokumen. Hubungi kami untuk estimasi spesifik.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{ padding: "80px 32px", background: "#fff" }}>
          <div style={{ maxWidth: 720, margin: "0 auto" }}>
            ...
            {faqs.map((faq, i) => (
              <div key={i} style={{ borderTop: "1px solid #d9d9dd", padding: "24px 0" }}>
                <details>
                  <summary style={{
                    fontSize: 17,
                    fontWeight: 400,
                    ...
                    {faq.q}
                    <span style={{ fontSize: 20, color: "#93939f", flexShrink: 0 }}>+</span>
                  </summary>
                  <p style={{ fontSize: 15, color: "#616161", lineHeight: 1.6, marginTop: 16, paddingRight: 32 }}>
                    {faq.a}
                  </p>
                </details>
              </div>
